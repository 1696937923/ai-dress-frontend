...
function onBeforeRouteLeave(leaveGuard) {
  ...
  const activeRecord = (void 0)(matchedRouteKey, {}).value;
  if (!activeRecord) {
...
function useLink(props) {
  const router = (void 0)(routerKey);
  const currentRoute = (void 0)(routeLocationKey);
  let hasPrevious = false;
  let previousTo = null;
  const route = (void 0)(() => {
    const to = (void 0)(props.to);
...
- props:`, props);
  ...
  const activeRecordIndex = (void 0)(() => {
  ...
  const isActive = (void 0)(() => activeRecordIndex.value > -1 && includesParams(currentRoute.params, route.value.params));
  const isExactActive = (void 0)(() => activeRecordIndex.value > -1 && activeRecordIndex.value === currentRoute.matched.length - 1 && isSameRouteLocationParams(currentRoute.params, route.value.params));
  function navigate(e = {}) {
    if (guardEvent(e)) {
      const p = router[(void 0)(props.replace) ? "replace" : "push"]((void 0)(props.to)).catch(noop);
  ...
  if (isBrowser) {
    ...
    if (instance) {
      ...
      (void 0)(() => {
        ...
        linkContextDevtools.error = isRouteLocation((void 0)(props.to)) ? null : 'Invalid "to" value';
      }, { flush: "post" });
    }
  }
  return {
    route,
    href: (void 0)(() => route.value.href),
    isActive,
    isExactActive,
    navigate
  };
...
var RouterLinkImpl = (void 0)({
  ...
  useLink,
  setup(props, { slots }) {
    const link = (void 0)(useLink(props));
    const { options } = (void 0)(routerKey);
    const elClass = (void 0)(() => ({
      [getLinkClass(props.activeClass, options.linkActiveClass, "router-link-active")]: link.isActive,
      [getLinkClass(props.exactActiveClass, options.linkExactActiveClass, "router-link-exact-active")]: link.isExactActive
    }));
    return () => {
      const children = slots.default && preferSingleVNode(slots.default(link));
      return props.custom ? children : (void 0)("a", {
...
var RouterViewImpl = (void 0)({
  ...
  setup(props, { attrs, slots }) {
    warnDeprecatedUsage();
    const injectedRoute = (void 0)(routerViewLocationKey);
    const routeToDisplay = (void 0)(() => props.route || injectedRoute.value);
    const injectedDepth = (void 0)(viewDepthKey, 0);
    const depth = (void 0)(() => {
      let initialDepth = (void 0)(injectedDepth);
      const { matched } = routeToDisplay.value;
      let matchedRoute;
      while ((matchedRoute = matched[initialDepth]) && !matchedRoute.components) initialDepth++;
      return initialDepth;
    });
    const matchedRouteRef = (void 0)(() => routeToDisplay.value.matched[depth.value]);
    (void 0)(viewDepthKey, (void 0)(() => depth.value + 1));
    (void 0)(matchedRouteKey, matchedRouteRef);
    (void 0)(routerViewLocationKey, routeToDisplay);
    const viewRef = (void 0)();
    (void 0)(() => [
      viewRef.value,
    ...
    return () => {
      ...
      const component = (void 0)(ViewComponent, assign({}, routeProps, attrs, {
        onVnodeUnmounted,
        ref: viewRef
      }));
...
function createRouter(options) {
  ...
  const currentRoute = (void 0)(START_LOCATION_NORMALIZED);
...
${JSON.stringify(newTargetLocation, null, 2)}
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`);
  ...
  function handleScroll(to, from, isPush, isFirstNavigation) {
    ...
    return (void 0)().then(() => scrollBehavior(to, from, scrollPosition)).then((position) => position && scrollToPosition(position)).catch((err) => triggerError(err, to, from));
  }
  ...
  const router = {
    ...
    install(app) {
      ...
      app.provide(routeLocationKey, (void 0)(reactiveRoute));
...
function useRouter() {
  return (void 0)(routerKey);
}
function useRoute(_name) {
  return (void 0)(routeLocationKey);
}
export {
